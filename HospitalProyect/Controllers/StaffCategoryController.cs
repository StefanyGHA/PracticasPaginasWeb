...
namespace HospitalProyect.Controllers
{
	...
	{
		private readonly Repositories.StaffCategoryRepository _staffCategoryRepository;

		public StaffCategoryController(Repositories.StaffCategoryRepository staffCategoryRepository)
		{
